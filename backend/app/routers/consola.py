...
def _accion_to_schema(a) -> AccionPropuestaRead:
    ...
    return AccionPropuestaRead(
        ...
        asunto=getattr(a, "asunto", None),
        mensaje_sugerido=a.mensaje_sugerido,
        razonamiento=getattr(a, "razonamiento", None),
        fuentes_consultadas=getattr(a, "fuentes_consultadas", None) or [],
...
def crear_accion(
    ...
    accion = AccionPropuestaModel(
        ...
        razonamiento=payload.razonamiento,
        fuentes_consultadas=payload.fuentes_consultadas or [],
